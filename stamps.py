...
class StaMPSEXE:
    ...
    def run(self):
        ...
        if platform.system() == 'Windows':
            ...
            os.system(f"sudo matlab -nojvm -nosplash {self.display} -r \"run('{os.path.split(os.path.abspath(__file__))[0]}/modules/StaMPS/autorun_{self.oobj.lower()}.m'); exit;\" > {self.config['processing_parameters']['current_result']}/STAMPS.log")
        time.sleep(1)
