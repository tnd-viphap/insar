    ...
    def process(self):
        ...
        if self.stamps_flag == 'NORMAL':
            ...
            if platform.system() == 'Windows':
                ...
                os.system(f"echo Viphap@2023 | sudo -S matlab -nojvm -nosplash -nodisplay -r \"run('{self.config['project_definition']['project_folder']}/modules/TomoSAR/Tomography/scripts/PSDS_main.m'); exit;\" > {self.config['processing_parameters']['current_result']}/{flag.upper()}.log")
